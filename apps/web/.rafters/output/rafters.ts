...
export const tokens = {
  ...
  elevation: {
    ...
    "elevation-scale": {
      levels: {
        surface: { depth: "depth-base", shadow: "shadow-none" },
        raised: { depth: "depth-base", shadow: "shadow-sm" },
        overlay: { depth: "depth-dropdown", shadow: "shadow" },
        sticky: { depth: "depth-sticky", shadow: "shadow-md" },
        modal: { depth: "depth-modal", shadow: "shadow-lg" },
        popover: { depth: "depth-popover", shadow: "shadow-xl" },
        tooltip: { depth: "depth-tooltip", shadow: "shadow-lg" },
      },
  ...
  motion: {
    ...
    /** Fade out animation */
    "motion-animation-fade-out":
      "fade-out var(--motion-duration-fast) var(--motion-easing-ease-in)",
    /** Slide in from top */
    "motion-animation-slide-in-from-top":
      "slide-in-from-top var(--motion-duration-normal) var(--motion-easing-ease-out)",
    /** Slide in from bottom */
    "motion-animation-slide-in-from-bottom":
      "slide-in-from-bottom var(--motion-duration-normal) var(--motion-easing-ease-out)",
    /** Slide in from left */
    "motion-animation-slide-in-from-left":
      "slide-in-from-left var(--motion-duration-normal) var(--motion-easing-ease-out)",
    /** Slide in from right */
    "motion-animation-slide-in-from-right":
      "slide-in-from-right var(--motion-duration-normal) var(--motion-easing-ease-out)",
    /** Slide out to top */
    "motion-animation-slide-out-to-top":
      "slide-out-to-top var(--motion-duration-fast) var(--motion-easing-ease-in)",
    /** Slide out to bottom */
    "motion-animation-slide-out-to-bottom":
      "slide-out-to-bottom var(--motion-duration-fast) var(--motion-easing-ease-in)",
    /** Slide out to left */
    "motion-animation-slide-out-to-left":
      "slide-out-to-left var(--motion-duration-fast) var(--motion-easing-ease-in)",
    /** Slide out to right */
    "motion-animation-slide-out-to-right":
      "slide-out-to-right var(--motion-duration-fast) var(--motion-easing-ease-in)",
    /** Scale in with spring */
    "motion-animation-scale-in":
      "scale-in var(--motion-duration-normal) var(--motion-easing-spring)",
    /** Scale out */
    "motion-animation-scale-out":
      "scale-out var(--motion-duration-fast) var(--motion-easing-ease-in)",
    /** Continuous spin */
    ...
    "motion-animation-accordion-down":
      "accordion-down var(--motion-duration-normal) var(--motion-easing-ease-out)",
    /** Accordion collapse */
    "motion-animation-accordion-up":
      "accordion-up var(--motion-duration-normal) var(--motion-easing-ease-out)",
    /** Caret blinking */
  ...
  shadow: {
    ...
    "shadow-sm":
      "0 0.063rem 0.25rem 0rem rgb(0 0 0 / 0.06), 0 0.063rem 0.125rem 0rem rgb(0 0 0 / 0.1)",
    /** Default shadow - standard elevation */
    shadow:
      "0 0.125rem 0.375rem -0.062rem rgb(0 0 0 / 0.1), 0 0.063rem 0.125rem 0rem rgb(0 0 0 / 0.1)",
    /** Medium shadow - noticeable elevation */
    "shadow-md":
      "0 0.25rem 0.5rem -0.125rem rgb(0 0 0 / 0.1), 0 0.125rem 0.25rem -0.062rem rgb(0 0 0 / 0.1)",
    /** Large shadow - significant elevation */
    "shadow-lg":
      "0 0.5rem 1rem -0.187rem rgb(0 0 0 / 0.1), 0 0.25rem 0.5rem -0.125rem rgb(0 0 0 / 0.1)",
    /** Extra large shadow - high elevation */
    "shadow-xl":
      "0 1.25rem 1.5rem -0.25rem rgb(0 0 0 / 0.1), 0 0.5rem 1rem -0.187rem rgb(0 0 0 / 0.1)",
    /** Maximum shadow - highest elevation */
    "shadow-2xl": "0 1.5rem 3rem -0.5rem rgb(0 0 0 / 0.25)",
    /** Primary colored shadow for emphasis */
    "shadow-primary":
      "0 0.125rem 0.375rem -0.062rem color-mix(in oklch, var(--primary) 12%, transparent)",
    /** Destructive colored shadow for warnings */
    "shadow-destructive":
      "0 0.125rem 0.375rem -0.062rem color-mix(in oklch, var(--destructive) 12%, transparent)",
