...
function Swatch({
  ...
  const sizeClass = size === "lg" ? "h-24 w-24" : size === "md" ? "h-12 w-12" : "h-8 w-8";
  return (
          ...
          <div>
            ...
            <div className="flex gap-6 mt-3">
              ...
              <span className="text-xs text-neutral-500 self-center">
                Best foreground: <strong>{analysis.contrast.recommendedForeground}</strong>
              </span>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <Swatch color={analysis.harmony.complementary} label="complement" />
                </div>
              </div>
              <div>
              ...
              <div>
                <p className="text-xs text-neutral-500 mb-2">Split Complementary</p>
                <div className="flex gap-2">
                  <Swatch color={analysis.oklch} label="base" />
                  <Swatch color={analysis.harmony.splitComplementary[0]} label="+150" />
                  <Swatch color={analysis.harmony.splitComplementary[1]} label="+210" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              <div className="flex flex-col items-center rounded-lg bg-neutral-50 p-4">
                <span className="text-2xl font-bold">{analysis.oklch.l}</span>
              ...
              <div className="flex flex-col items-center rounded-lg bg-neutral-50 p-4">
                <span className="text-2xl font-bold">{analysis.oklch.c}</span>
              ...
              <div className="flex flex-col items-center rounded-lg bg-neutral-50 p-4">
                <span className="text-2xl font-bold">{analysis.oklch.h}</span>
